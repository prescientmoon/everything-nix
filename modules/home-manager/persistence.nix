    ...
    let
      makeLocation =
        ...
        lib.attrsets.nameValuePair location.home {
          ...
          allowOther = true;
          directories = lib.lists.flatten (lib.attrsets.mapAttrsToList (_: mkAppDirectory) location.apps);

          files = lib.lists.flatten (lib.attrsets.mapAttrsToList (_: mkAppFiles) location.apps);
        };
      # }}}
    in
    lib.mkIf cfg.enable {
